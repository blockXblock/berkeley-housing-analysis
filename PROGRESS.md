...
**OPEN for John (gated):** (1) 2205/2201 Blake (proj54/proj62) share parcel_id 52 in project_parcels → both got identical 13,288sf footprint; one has a wrong/stale APN (adjacent lots) — needs a gated v2 APN fix; hold both footprints till then. (2) 2b gating deletions of true dup placemarks 2099 MLK + 2740 Shasta. Snapshots this session: `keep_snapshot_2026-08-25_pre-{tower,camera,major,bart-classification}-ingest.db`.
