...
**The Mayor's referral** (Action Calendar, Sept 29) gets the diagnosis
exactly right, in Vision 2050's own terms: it names the two missing
instruments — a cross-departmental **Program Plan** and a **Strategic Asset
Management Plan** — grounds them in the documented chain (the 2020
Framework, the 2021 progress report, the May 2022 SAMP and Asset Management
Policy), and points to a concrete dashboard model. With the Mayor as
author, it passes.

But a referral is Council's weakest instrument: no return date, no
...
5. **Operationalize the Auditor.** The City Auditor signed the campaign's
   ballot argument citing oversight; an audit plan per bond series,
   published before November, converts a signature into a mechanism.
6. **Run the leverage story.** T1's $100M leveraged ~$83M in outside funds
   — documented, popular, and a ranking criterion in the amended referral.
7. **Answer the Parks Commission in public.** Its April report (pool
   strategy, Southeast quadrant, scoring transparency) was formally
   received and never answered. A written response costs a staff afternoon
...
Both cynicisms are correct, and they cancel in an instructive place. **On
one hand**, any Council measure is just words: referrals queue for years,
resolutions are amendable by the next majority, and the 2022 asset policy
is standing proof that adoption ≠ implementation. **On the other hand**,
strict project commitments would be bad governance, not merely
unrealistic: over a decade of issuance and forty years of repayment, costs
move, grants appear and vanish, leases fail, seawalls crack. The City
Manager genuinely needs flexibility — the King re-scope, on its merits,
was a *correct* exercise of it.

The synthesis: **bind the process, not the projects.** Commitments to
specific projects break the first time circumstances change. Commitments
about *how decisions get made* — published criteria, lifecycle analysis
before funding, a public change log, audits — survive every change of
circumstance, because they constrain nothing except the obligation to show
the work. Flexibility is legitimate; *undocumented* flexibility is what
Vision 2050 was written against.

## The November math: closer than 72% suggests

**Measure U needs two-thirds.** The City's survey put $300M at **72%**
pre-campaign; the last comparable test, **2022's Measure L, got 59.4% and
failed** against essentially unfunded opposition. Standard erosion under
an organized "No" is 5–15 points.

**The vote arithmetic is smaller than people think.** In November 2022,
44,675 Berkeley ballots were cast on Measure L; expect roughly 45–50,000
on Measure U. One-third-plus-one is about **15,000–16,700 No votes to
defeat a $300 million bond** — and **18,130 Berkeley voters said No to
Measure L with no funded campaign asking them to**. The coalition that
defeats Measure U has already voted once, recently, and it was larger than
it needs to be.

**Who pays most is not "the median homeowner" — it is the newest ones.**
Because the tax is ad valorem, Prop 13 splits homeowners into two
populations by purchase date:

- A 1980s buyer with $200K of assessed value pays roughly **$45–70/yr**.
- A young family that just bought at **$1.5M** pays $332/yr at the
  advertised average — but the advertised $22.14/$100K average is diluted
  by decades of citywide base growth; their own realized lifetime average
  is nearer **$500/yr, rising toward ~$690/yr at the 2040 peak**, stacked
  on ~$660/yr for existing bond levies and the full parcel-tax load, while
  carrying a maximum mortgage.
- A **new condo buyer at $800K** — the first rung — pays roughly
  **$265/yr realized average, ~$370/yr at peak**, for the same services a
  long-tenured neighbor receives for a tenth the price.
- The largest single checks land on **new apartment buildings** (a
  $100M-AV building: ~$22,000/yr average, $35,000 at peak) — the measure
  taxes hardest exactly the new housing the City wants built, owned by
  exactly the parties with the organization and money to run a
  personalized-cost campaign. The informational tool already exists:
  per-parcel cost lookups are public.

The generational asymmetry is the campaign's hidden vulnerability: the
households paying the most — recent buyers, younger, newer to Berkeley —
are demographically the most reliable yes-on-everything voters in the
city, and none of them has yet been shown their own number. A mailer that
says "your neighbor pays $60; you pay $500 — for a list of
maybe-projects" does not need to convert anyone; it needs to move one in
