...
INVESTOR = re.compile(r"\b(LLC|L\.L\.C|INC|CORP|CO|COMPANY|LTD|LP|L\.P|LLP|PARTNERS|PARTNERSHIP|PROPERTIES|"
                      r"HOLDINGS|VENTURES|CAPITAL|REALTY|MANAGEMENT|INVESTMENTS?|ENTERPRISES|GROUP|ASSOCIATES)\b")
TRUST = re.compile(r"\bTRUST|TRUSTEE|LIVING TR|FAMILY TR|REVOCABLE\b")
INSTIT = re.compile(r"\b(UNIVERSITY|REGENTS|CITY OF|COUNTY|STATE OF|CHURCH|SCHOOL|DISTRICT|CALIFORNIA|"
                    r"HOUSING AUTH|FOUNDATION|ASSOCIATION|CONGREGATION|TEMPLE)\b")
