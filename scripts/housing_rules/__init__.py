...
Public surface (re-exported from submodules):
    Data:
        RHNA_ALLOCATIONS, RHNA_CYCLES, PROJECTION_PERIODS, INCOME_TIERS, STREAMLINING_PROVISIONS
    Functions:
...
from .owner_name import owner_type, is_organisation  # THE owner-name classifier (lifted 2026-09-07)
